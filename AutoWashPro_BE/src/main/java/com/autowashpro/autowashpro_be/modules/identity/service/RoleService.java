...
public class RoleService {
    ...
    public List<RoleResponse> getAllRoles() {
        return roleRepository.findAll().stream()
                .map(role -> mapper.toRoleResponse(role, staffRepository.countByRoleId(role.getRoleId())))
                .toList();
    }
    ...
    public RoleResponse updateRole(Integer roleId, UpdateRoleRequest request) {
        ...
        Role saved = roleRepository.save(role);
        return mapper.toRoleResponse(saved, staffRepository.countByRoleId(saved.getRoleId()));
    }
    ...
    public RoleResponse updateRolePermissions(Integer roleId, UpdateRolePermissionsRequest request) {
        ...
        if (PermissionCatalog.SYSTEM_ROLE_NAMES.contains(role.getRoleName())
            ...
            throw new BadRequestException("ROLE_ADMIN must retain at least one permission");
        }
